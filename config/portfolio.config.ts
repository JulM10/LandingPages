    ...
    services: [
      {
        ...
        details: 'Nos especializamos en proyectos de construcción de mediano y gran envergadura. Contamos con un equipo experimentado en gestión de obras, coordinación de subcontratistas y control de calidad. Trabajamos con metodologías ágiles y supervisión permanente en sitio.',
        features: [
          'Obra civil y estructural',
      ...
      },
      {
        ...
        details: 'Creamos espacios que combinan funcionalidad, estética y sostenibilidad. Nuestro equipo de diseñadores realiza un análisis profundo de tus necesidades y propone soluciones innovadoras que optimizan cada rincón de tu proyecto.',
        features: [
      ...
      },
      {
        ...
        details: 'Gestionamos tu proyecto desde la conceptualización hasta la entrega final. Realizamos estudios de viabilidad, elaboramos presupuestos detallados y coordenamos todos los aspectos técnicos y administrativos necesarios para el éxito de tu proyecto.',
        features: [
